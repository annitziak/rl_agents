...
RACETRACK_CONFIG = {
    "critic_hidden_size": [192, 96, 192],   #initial were [32, 32, 32]
    "policy_hidden_size": [96, 96, 48]  #initial were [32, 32, 32]
}
...
RACETRACK_HPARAMS = {
    "critic_hidden_size": [192, 96, 192],
    "policy_hidden_size": [96, 96, 48] 
    }

#SWEEP = True  # Enable hyperparameter tuning
#HPARAMS_SWEEP = {
#    "critic_hidden_size": [[128, 128], [256, 256], [400, 300]],  # Trying different architectures
#    "policy_hidden_size": [[128, 128], [256, 256], [400, 300]], 
#}
...
def play_episode(
    ...
    obs, _ = env.reset()
    #print("Debug Initial observation:", obs.shape, obs.dtype)  # Debugging
...
if __name__ == "__main__":
    if ENV == "RACETRACK":
        ...
        #print("CONFIG: ", CONFIG)
        #print("Config:", RACETRACK_CONFIG["critic_hidden_size"])
